...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/tilt-1.1/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/tilt-1.1/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/dm-appengine-0.1.2/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rack-1.2.1/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rack-1.2.1/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/sinatra-1.1.0/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/jruby-jars-1.5.3/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/appengine-apis-0.0.21/lib")
...
module Gem
  def self.ruby ; "/home/oren/.rvm/rubies/jruby-1.5.3/bin/jruby" ; end
